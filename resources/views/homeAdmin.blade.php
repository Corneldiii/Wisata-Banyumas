...
<html lang="en">
  ...
  <body>
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="#">
              <img src="/path/to/profile-pic.jpg" alt="Profile Picture" class="rounded-circle" width="30" height="30">
              Nama Akun
            </a>
          </li>
        </ul>
    ...
    <section id="dashboard" class="d-flex justify-content-center align-items-center">
        <img src="/storage/img/admin/dashboard/logoSIG.png" class="img-thumbnail w-25 h-50" style="opacity: 0.5; border: none" alt="">
    </section>
